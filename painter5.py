...
def main():
    ...
    model.fit_generator(train_generator,epochs=50,steps_per_epoch=train_generator.n/batch_size
                        ,validation_data=vaild_generator,validation_steps=vaild_generator.n/batch_size,verbose=1)
                        #
